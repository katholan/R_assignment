...
Plot SNPs/Chromosomes

I realized that I misunderstood what each Base/Base meant, erroneously thinking
only the heterozygous site were SNPs (when in fact they all are), and this code 
reflects that mistake.
```{r}
