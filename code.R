...
log_snp_genotype[log_snp_genotype == "A/A"] <- 0
log_snp_genotype[log_snp_genotype == "C/C"] <- 0
log_snp_genotype[log_snp_genotype == "G/G"] <- 0
log_snp_genotype[log_snp_genotype == "T/T"] <- 0
...
genotypes_log[genotypes_log == "A/A"] <- 0
genotypes_log[genotypes_log == "C/C"] <- 0
genotypes_log[genotypes_log == "G/G"] <- 0
genotypes_log[genotypes_log == "T/T"] <- 0
